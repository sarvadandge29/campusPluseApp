...
const YourComponent = () => {
  ...
  containerStyles="mt-10 w-[60%] h-[48] border border-black rounded-[5px]" // Updated styles
  textStyle="text-blue" // Custom text styles
  isLoading={false} // Set to true if the button is in a loading state
/>
    </View>
  );
};
